...
function RhtFuncPlotting(){
    ...
    this.draw_interior_plot = function( f, color ) {
        var step = 1;
        var draw_interior_line = function( x1, y1 ) { draw_sane_line( x1, y1, x1, yPhase*(pxPerCell/defaultPxPerCell)+0.001, color ); };
...
$(document).ready( function() {
   var plotEvents = new RhtFunctionPlottingEvents();
   plotEvents.on_load();
});
